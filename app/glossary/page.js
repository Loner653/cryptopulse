  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.pageTitle}>
        Crypto Glossary Hub{" "}
        <span className={styles.highlight}>Terms ({filteredTerms.length})</span>
      </h1>
      <input
        type="text"
        placeholder="Search terms (e.g., HODL, DeFi)..."
        value={search}
      ...
      <div className={styles.section}>
        ...
        {filteredTerms.length === 0 ? (
          <p className={styles.feedback}>No terms found for this search or category.</p>
        ) : (
          <ul>
            {filteredTerms.map((t) => (
              <li key={t.term}>
